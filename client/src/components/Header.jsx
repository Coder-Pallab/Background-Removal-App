  ...
  return (
    <div className='flex items-center justify-between max-sm:flex-col-reverse
        ...
        <div>
            ...
            <p className='my-6 text-[15px] text-gray-500'>An AI-powered app that removes image backgrounds instantly <br className='max-sm:hidden'/>
            with clean, accurate results — simple, fast, and effortless.</p>
